      ...
      <div class="container" style="width: 100%;">
          <div style="text-align: center">
             <div class="theme-table-image col-sm-3">
                    <img src="../img/images/android.JPG" class="img-rounded" height="95%" width="95%" style="background-color: #e9e9f1"><br>
                    <h4>Android and ios app development</h4>
             </div>
             <div class="theme-table-image col-sm-3">
                    <img src="../ashik/main/images/2.png" height="95%" class="img-rounded" width="95%" style="background-color: #e9e9f1"><br>
              ...
              <div class="container" style="width: 100%;">
                  <div style="text-align: center">
                     ...
                     <div class="theme-table-image col-sm-4">
                            <img src="../ashik/main/images/2.png" height="50%" class="img-circle" width="50%" style="background-color: white"><br>
